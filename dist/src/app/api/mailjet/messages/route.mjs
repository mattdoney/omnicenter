...
async function getContactId(emailAddress, auth) {
...
async function getMessages(contactId, auth) {
    ...
    try {
        ...
        const messagesWithDetails = await Promise.all(data.Data.map(async (msg) => {
